    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-white to-primary/5 dark:from-slate-950 dark:via-slate-900 dark:to-primary/10">
      ...
      <section className="relative overflow-hidden pt-16 pb-20 px-4">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="animate-float absolute -top-32 -left-32 w-96 h-96 rounded-full bg-primary/8 blur-3xl" style={{ animationDelay: '0s' }} />
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            <ProtectedLink
              href="/audit/new"
              className="animate-pulse-ring inline-flex items-center justify-center gap-2 rounded-2xl bg-primary hover:bg-primary/90 px-8 py-3.5 text-white font-semibold shadow-lg shadow-primary/30 transition-all hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-0.5"
            >
      ...
      <main id="audits" className="flex-1 max-w-5xl mx-auto px-4 pb-16 w-full">
        ...
        {audits.length === 0 ? (
          ...
          >
            ...
            <ProtectedLink
              href="/audit/new"
              className="inline-flex items-center gap-2 rounded-2xl bg-primary px-6 py-3 text-white font-semibold text-sm hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25"
            >
