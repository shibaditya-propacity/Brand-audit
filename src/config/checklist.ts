...
export const CHECKLIST_ITEMS: ChecklistItem[] = [
  ...
  { code: 'D3-14', dimension: 'D3', category: 'YouTube Presence', label: 'YouTube channel is active with recent uploads', description: 'Channel has published at least one video in the last 60 days', type: 'VERIFIABLE', weight: 1, dataSource: 'YouTubeDataAPI' },
  { code: 'D3-15', dimension: 'D3', category: 'YouTube Presence', label: 'YouTube subscriber count > 1,000', description: 'Channel has a meaningful subscriber base of at least 1,000', type: 'VERIFIABLE', weight: 1, dataSource: 'YouTubeDataAPI' },
  { code: 'D3-16', dimension: 'D3', category: 'YouTube Performance', label: 'Upload frequency >= 2 videos per month', description: 'Channel maintains a consistent posting cadence for algorithmic reach', type: 'VERIFIABLE', weight: 1, dataSource: 'YouTubeDataAPI' },
  { code: 'D3-17', dimension: 'D3', category: 'YouTube Performance', label: 'Content includes project walkthroughs, site visits, or testimonials', description: 'Videos go beyond ads — real estate buyers trust walkthrough content for decisions', type: 'QUALITATIVE', weight: 1, dataSource: 'YouTubeDataAPI' },
  { code: 'D3-18', dimension: 'D3', category: 'YouTube Performance', label: 'Average video views > 500', description: 'Videos achieve meaningful organic reach per upload', type: 'VERIFIABLE', weight: 1, dataSource: 'YouTubeDataAPI' },
  { code: 'D3-19', dimension: 'D3', category: 'YouTube Branding', label: 'Channel branding is complete and on-brand', description: 'Channel has a banner, profile picture matching brand, and a keyword-rich channel description', type: 'QUALITATIVE', weight: 1, dataSource: 'YouTubeDataAPI' },
  { code: 'D3-20', dimension: 'D3', category: 'YouTube Branding', label: 'Video titles use location and project keywords for SEO', description: 'Titles include city, project name, or segment keywords to be discoverable on YouTube search', type: 'QUALITATIVE', weight: 1, dataSource: 'YouTubeDataAPI' },
